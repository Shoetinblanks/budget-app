    ...
    <div className="max-w-4xl mx-auto px-4 py-16 text-zinc-300">
      ...
      <div className="space-y-6 text-sm leading-relaxed">
        <section>
          ...
          <p>
            Welcome to Shoe Budgeting. This Privacy Policy explains how Shoetinblanks LLC (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) 
            collects, uses, and discloses information about you when you use the Shoe Budgeting platform.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-2">
            Shoe Budgeting is designed to help you manage your personal finances. We take the privacy and security 
            of your financial data extremely seriously.
          </p>
          <ul className="list-disc pl-6 space-y-1">
            <li>Your financial data is stored securely using an encrypted PostgreSQL database, ensuring only your authenticated account can access your data.</li>
            <li><strong>Plaid Integration:</strong> We use Plaid Inc. (&quot;Plaid&quot;) to connect your Shoe Budgeting account with your bank account, credit card, or other financial accounts. By using our service, you grant Shoetinblanks LLC and Plaid the right, power, and authority to act on your behalf to access and transmit your personal and financial information from the relevant financial institution. You agree to your personal and financial information being transferred, stored, and processed by Plaid in accordance with the Plaid Privacy Policy.</li>
        ...
        <section>
          ...
          <p>
            Shoe Budgeting is a service provided by Shoetinblanks LLC. If you have any questions about this Privacy Policy, 
